    ...
    const html = `
      ...
      "vi-VN"
          ...
          <div style="background:#f3f4f6;padding:20px;text-align:center;">
            ...
            <img src="ccid:qrCheckin@cinema" alt="QR Check-in" style="width:160px;height:160px;border-radius:12px;border:3px solid #16a34a;background:white;" />
        ...
        <div style="max-width:640px;margin:auto;background:white;border-radius:16px;box-shadow:0 2px 8px rgba(0,0,0,0.1);overflow:hidden;">
          ...
          <div style="padding:24px 28px;">
            ...
            <div style="margin-top:25px;text-align:center;">
              ...
              <img src="cid:qrCheckin@cinema" alt="QR Check-in" style="width:180px;height:180px;border:3px solid #16a34a;border-radius:12px;" />
