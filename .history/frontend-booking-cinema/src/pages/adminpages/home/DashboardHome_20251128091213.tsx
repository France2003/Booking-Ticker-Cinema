...
const DashboardHome = () => {
  ...
  const loadRevenue = async () => {
    ...
    if (revenueType === "week") res = await fetchRevenueLast7Days();
  ...
  return (
    <AdminLayout>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-5 gap-6">
        ...
        <StatCard title="Đơn hàng" value={totalBookings.toLocaleString()} change={`Chờ duyệt: ${pendingBookings}`} icon={<ShoppingCart />} positive />
