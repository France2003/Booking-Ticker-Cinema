...
function CameraController({
  ...
  useEffect(() => {
    if (targetCam) movingRef.current = true; // bắt đầu di chuyển khi chọn ghế
  }, [targetCam]);

  useFrame(() => {
    if (!targetCam || !movingRef.current) return;
    ...
    // Khi đã gần → dừng lại → trả quyền điều khiển cho OrbitControls
