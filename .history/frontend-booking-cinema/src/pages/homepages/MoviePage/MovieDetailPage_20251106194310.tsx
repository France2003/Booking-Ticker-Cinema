...
export default function MovieDetailPage() {
    ...
    const [isLoading, setIsLoading] = useState<boolean>(true); // dùng cho phim
    const [isShowtimeLoading, setIsShowtimeLoading] = useState<boolean>(true); // dùng riêng cho suất chiếu
