                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-start">
                    ...
                    <div className="md:col-span-2 space-y-3">
                        ...
                        <ul className="space-y-1 text-gray-700 text-sm md:text-base">
                            ...
                            <li><b>Rate:</b> <pageYOffset className={`${color} font-bold`}>C{movie.danhGia}</pageYOffset>- Phim cấm phổ biến đến khán giả dưới {movie.Age} tuổi   </li>
                ...
                <div className="mt-12 border-t pt-6">
                    ...
                    <div className="mb-6">
                        ...
                        <textarea
                            ...
                            className="w-full border rounded-lg p-2 mt-2 caret-black"
