                    ...
                    <div className="p-6 bg-gradient-to-b from-[#fffaf5] to-white space-y-6">
                        ...
                        <div className="bg-white rounded-2xl shadow-md p-6 border border-gray-100">
                            ...
                            <div className="flex flex-col md:flex-row gap-6 items-start">
                                ...
                                {/* Suất chiếu */}
                                <div className="flex-1 min-h-[120px] grid place-items-center">
                                    {isLoading ? (
                                        // ✅ chỉ phần suất chiếu loading
                                        ...
                                        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 w-full">
                                            {filtered.map((st) => (
                                                <motion.button
                                                    key={st._id}
                                                    whileHover={!isPastShowtime(st.startTime) ? { scale: 1.05 } : {}}
                                                    disabled={isPastShowtime(st.startTime)}
                                                    onClick={() => {
                                                        if (!isPastShowtime(st.startTime)) onSelect(st);
                                                    }}
                                                    className={`flex flex-col items-center justify-center h-[100px] border-2 rounded-xl transition-all duration-200${isPastShowtime(st.startTime)
