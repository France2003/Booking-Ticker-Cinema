    ...
    return (
        <section className="w-full -mt-[35px] py-10">
            ...
            <div className="relative">
                <div
                    ref={sliderRef}
                    className="flex gap-4 sm:gap-5 overflow-x-hidden no-scrollbar select-none px-2 py-2 cursor-grab"
                >
                    ...
                    hover:from-orange-500 hover:to-red-400 text-white font-bold px-4 sm:px-5 py-2 rounded-full shadow-md"
                                    >
